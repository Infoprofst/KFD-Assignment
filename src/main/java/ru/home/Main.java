        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            while (input != 6) {
                ...
                switch (input) {
                    ...
                    case 3 -> {
                        Map<String, List<UserDataResponseDto>> map = service.sortUsersByType();
                        for (Map.Entry<String, List<UserDataResponseDto>> user : map.entrySet()) {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            while (input != 6) {
                ...
                switch (input) {
                    ...
                    case 4 -> {
                        System.out.println(service.sortBooksByAuthor());
                    }
                    case 6 -> {
                        System.out.println("Terminating program");
                    }
